...
class UserHandler
{
    ...
    public static function verifyLogin(string $email, $password)
    {
    ...
    public static function getUser($id, $full = false): ?User
    {
        ...
        if ($data) {
            ...
            if ($full) {
                ...
                ///followers
                $followers = UserRelation::select('user_to', 'user_from', $id)->get();
                foreach ($followers as $follower) {
                    if (isset($follower['user_from'])) {
                ...
                //following
                $following = UserRelation::select('user_from', 'user_to', $id)->get();
